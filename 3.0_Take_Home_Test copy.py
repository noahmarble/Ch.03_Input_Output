...
area
areaOfRectangle
AreaOfRectangle         this it describes the variable
'''
...
print(a)
a=45
a is defined after it is being asked to print
'''
...
to an integer.
'''
length = int(input("length of a square: "))
...
'''
radious = int(input("radious of an elipse: "))
radious2 = int(input("second radious of an elipse: "))
print("area of an ellipse: ", pi*radious*radious2)
'''
